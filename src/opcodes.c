...
void gbExecute(Gameboy *gb) {
    ...
    switch(op_code) {
        ...
        case (0x04): {
            ...
            gb->pc++;
            gb->b++;
            gbSetFlags(gb, gb->b == 0, 0, (gb->b & 0xF) == 0, -1);
        } break;
        case (0x05): {
            gb->cpu_clock += 4;
            gb->pc++;
            gb->b--;
            gbSetFlags(gb, gb->b == 0, 1, (gb->b & 0xF) == 0xF, -1);
        } break;
        case (0x06): {
            gb->cpu_clock += 4;
            gb->pc++;
        ...
        case (0x0C): {
            ...
            gb->pc++;
            gb->c++;
            gbSetFlags(gb, gb->c == 0, 0, (gb->c & 0xF) == 0x00, -1);
        } break;
        case (0x0D): {
            gb->cpu_clock += 4;
            gb->pc++;
            gb->c--;
            gbSetFlags(gb, gb->c == 0, 1, (gb->c & 0xF) == 0xF, -1);
        } break;
        case (0x0E): { 
            gb->cpu_clock += 4;
            gb->pc++;
        ...
        case (0x14): {
            ...
            gb->pc++;
            gb->d++;
            gbSetFlags(gb, gb->d == 0, 0, (gb->d & 0xF) == 0, -1);
        } break;
        case (0x15): {
            gb->cpu_clock += 4;
            gb->pc++;
            gb->d--;
            gbSetFlags(gb, gb->d == 0, 1, (gb->d & 0xF) == 0xF, -1);
        } break;
        case (0x16): {
            gb->cpu_clock += 4;
            gb->pc++;
        ...
        case (0x1C): {
            ...
            gb->pc++;
            gb->e++;
            gbSetFlags(gb, gb->e == 0, 0, (gb->e & 0xF) == 0x00, -1);
        } break;
        case (0x1D): {
            gb->cpu_clock += 4;
            gb->pc++;
            gb->e--;
            gbSetFlags(gb, gb->e == 0, 1, (gb->e & 0xF) == 0xF, -1);
        } break;
        case (0x1E): { 
            gb->cpu_clock += 4;
            gb->pc++;
        ...
        case (0x24): {
            ...
            gb->pc++;
            gb->h++;
            gbSetFlags(gb, gb->h == 0, 0, (gb->h & 0xF) == 0, -1);
        } break;
        case (0x25): {
            gb->cpu_clock += 4;
            gb->pc++;
            gb->h--;
            gbSetFlags(gb, gb->h == 0, 1, (gb->h & 0xF) == 0xF, -1);
        } break;
        case (0x26): { 
            gb->cpu_clock += 4;
            gb->pc++;
        ...
        case (0x2C): {
            gb->l++;
            gbSetFlags(gb, gb->l == 0, 0, (gb->l & 0xF) == 0, -1);
            gb->pc ++;
            gb->cpu_clock += 4;
        } break;
        case (0x2D): {
            ...
            gb->pc++;
            gb->l--;
            gbSetFlags(gb, gb->l == 0, 1, (gb->l & 0xF) == 0xF, -1);
        } break;
        case (0x2E): { 
            gb->cpu_clock += 4;
            gb->pc++;
        ...
        case (0x3C): {
            gb->a++;
            gbSetFlags(gb, gb->a == 0, 0, (gb->a & 0xF) == 0, -1);
            gb->pc ++;
            gb->cpu_clock += 4;
        } break;
        case (0x3D): {
            ...
            gb->pc++;
            gb->a--;
            gbSetFlags(gb, gb->a == 0, 1, (gb->a & 0xF) == 0xF, -1);
        } break;
        case (0x3E): { 
            gb->cpu_clock += 8;
            gb->pc++;
        ...
        case (0x3F): {
            gb->cpu_clock += 4;
            gb->pc++;
            gbSetFlags(gb, -1, 0, 0, (gb->f & C_FLAG) == 0);
        } break;
        case(0x76): { 
            gb->halted = true;
            gb->pc++;
